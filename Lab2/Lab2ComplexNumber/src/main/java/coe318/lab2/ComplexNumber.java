...
public class ComplexNumber {
    public double real, imaginary; //Instance variable declarations
...
//Initialize the instance variables
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        return new ComplexNumber((this.real*z.real)-(this.imaginary*z.imaginary), 
                (this.real*z.imaginary)+(this.imaginary*z.real));	//A stub: to be fixed
    }
    ...
    public ComplexNumber reciprocal() {
        return new ComplexNumber(this.real/(this.real*this.real+this.imaginary*this.imaginary),
                -this.imaginary/(this.imaginary*this.imaginary+this.real*this.real)); //A stub: to be fixed
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
        return new ComplexNumber(((this.real*z.real )+(this.imaginary*z.imaginary))/((z.real*z.real)+(z.imaginary*z.imaginary)),
                (((this.real*z.imaginary)-(this.imaginary*z.real))/((z.real*z.real)+(z.imaginary*z.imaginary))));	//A stub: to be fixed
    }
